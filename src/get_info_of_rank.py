...
def get_info_of_rank(range_rank,atom,atomtype,mass,numatoms,scalmatrix,period_table,coor,\
table_coor,neigh_atoms,batchsize,cutoff,device,np_dtype):
    ...
    com_coor_rank=get_com(coor_rank,mass_rank,cell_rank,numatoms_rank,maxnumatom,table_coor)
    ...
    return com_coor_rank,numatoms_rank,species_rank,mass_rank,atom_index_rank,shifts_rank
